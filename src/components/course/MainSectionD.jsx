  ...
  return (
    <div>
        {/* <div className='hidden md:block bg-gray-500'>
            <iframe width="260" height="315" src={`https://www.youtube.com/embed/${embedId}`} title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; " allowFullScreen controls className='lg:w-[570px] lg:h-[450px] xl:w-[620px]'/>
        </div> */}
        <div className='hidden md:block bg-gray-500'>
