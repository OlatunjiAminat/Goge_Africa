...
import contribute2 from "../../assets/contributor2.png"
...
function FormSection() {
  ...
  return (
    <div className='bg-normal-orange-rgba md:flex justify-around items-center h-screen'>
        <div className='md:w-[50%]'>
            <div className='flex items-center justify-center'>
                <img src={Logo2} alt="logo" className='w-56 pb-6 mt-8' />
            </div>
            <div  className='flex items-center justify-center'>
                <p className='text-gray-400 text-xs'>Get paid! sharing your knowledge</p>
            </div>
            <div className='flex items-center justify-center'>
                <form onSubmit={handleSubmit} action="/" method="">
                    ...
                    <p className='text-xs my-4 text-center text-gray-400 '>Already have an account? <Link to="../pages/SignIn" className='text-light-orange-rgba text-xs '>Sign In</Link></p>
                    <button disabled={isSubmitting} className='bg-deep-orange-rgba text-white border rounded-full px-4 mb-16 text-xs md:w-48 py-3 lg:w-80 py-3'>Become A Contributor</button>
                </form>
            </div>
        </div>
        ...
        <div className="hidden md:block md:max-w-[50%]">
            <img src={contribute2} alt="logo" className="h-[100%]" />
        </div> 
    </div>
  )
}
