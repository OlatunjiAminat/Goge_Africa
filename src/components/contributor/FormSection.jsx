...
import contribute from "../../assets/contributor.jpeg"
...
function FormSection() {
  return (
    ...
    <div className='bg-normal-orange-rgba'>
        ...
        <div className='flex items-center justify-center'>
            <form action="https://getform.io/f/1e3fb990-41e9-409e-9a8a-f3d0516627fd" method="POST">
                ...
                <button className='bg-deep-orange-rgba text-white border rounded-full px-4 mb-16 text-xs md:w-48 py-3 lg:w-56 py-3'>Become A Contributor</button>
            </form>
        </div>
    </div>
    ...
    <div className="hidden md:block">
         <img src={contribute} alt="logo" className="" />
    </div> 
