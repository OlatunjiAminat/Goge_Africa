  ...
  return (
    <div className='mx-[25%] mt-16 mb-4 font-sans flex justify-center items-center pt-16 pb-20 text-center border-[1px]'>
        ...
        <div className='text-deep-orange-rgba my-3 text-base'>
            <h3 className='font-medium'>Download Course Exercise Files</h3>
        </div>
        <div>
        ...
        <div className=''>
            <button className='border font-semibold py-3 px-6 rounded-full mr-6 mt-7 text-white bg-deep-orange-rgba text-xs'>Download</button>
        </div>
        </div>
  </div>
  )
