        ...
        <div className='bg-normal-orange-rgba'>
            ...
            <div className='flex items-center justify-center'>
                <form action="https://getform.io/f/1e3fb990-41e9-409e-9a8a-f3d0516627fd" method="POST">
                    <input type="text" placeholder='FullName' name="fName"  autocomplete="off" required className='focus:outline-none  focus:ring-1 focus:ring-grey-100 mt-6 block border border-grey-500 rounded-full pl-3 py-2 mb-2 w-56 text-xs md:py-3 lg:w-64 lg:py-4' />
                    ...
                    <p className='text-xs my-4 text-right text-gray-400'>Already have an account?<Link to="#" className='text-light-orange-rgba text-xs '>Sign In</Link></p>
